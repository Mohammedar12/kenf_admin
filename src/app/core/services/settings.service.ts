...
<<<<<<< HEAD
  ...
  delBrands(sysInfo) {
    return this.http.delete(environment.backend + `/settings/brands/` + sysInfo, this.httpOptions);
  }
  createBrands(sysInfo): Observable<any> {
    return this.http.post(environment.backend + `/settings/brands`, sysInfo, this.httpOptions);
  }
